...
openstack subnet create --network provider1 --gateway 192.168.1.1 --subnet-range 192.168.1.1/24  subnet1 --allocation-pool start=192.168.1.101,end=192.168.1.150
openstack network create  --share --external --provider-physical-network physnet2 --provider-network-type flat provider2
openstack subnet create --network provider2 --gateway 192.168.77.1 --subnet-range 192.168.77.1/24  subnet2 --allocation-pool start=192.168.77.101,end=192.168.77.150
